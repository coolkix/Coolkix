        ...
        <Grid container spacing={8} style={{ width: "80%" }}>
          <Grid container item xs={12}>
            <div>
              <Item>
                <div>
                  <Typography style={{ visibility: "visible" }} variant="h4">
                    <Link
                      style={{ textDecoration: "none", color: "black" }}
                      href="https://beziepakojuma.lv/"
                    >
                      Burka
                    </Link>
                  </Typography>
            ...
            <Item>
              <div>
                <Typography style={{ visibility: "visible" }} variant="h4">
                  <Link
                    style={{ textDecoration: "none", color: "black" }}
                    href="https://zemes-draugs.business.site/"
                  >
                    Zemes Draugs
                  </Link>
                </Typography>
              ...
              <div>
                <Typography>Rīga, Nometņu iela 18 k-1,</Typography>
              </div>
            </Item>
          </Grid>
          ...
          <Grid container item xs={12} style={{ width: "200%" }}>
            <Item>
              ...
              <div>
                <Typography>Rīga, Slokas iela 76b</Typography>
              </div>
            </Item>
          </Grid>
        </Grid>
